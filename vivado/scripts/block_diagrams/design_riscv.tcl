...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Decode_RamWrAdressRegNo [get_bd_pins Decode/RamWrAdressRegNo] [get_bd_pins Forward/AesRamAddressRegNo] [get_bd_pins RegisterSet/AesWrRamAddressRegNo]
