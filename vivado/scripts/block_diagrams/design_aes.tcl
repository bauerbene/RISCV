...
proc create_root_design { parentCell } {
  ...
  set WrRamAddressI [ create_bd_port -dir I -from 31 -to 0 WrRamAddressI ]
  set WrRamAddressO [ create_bd_port -dir O -from 31 -to 0 WrRamAddressO ]
  set WrToRamI [ create_bd_port -dir I WrToRamI ]
  set WrToRamO [ create_bd_port -dir O WrToRamO ]
  ...
  connect_bd_net -net AesSync_0_AesWrRamAddressO [get_bd_pins AesSync_0/AesWrRamAddressO] [get_bd_pins AesSync_1/AesWrRamAddressI]
  connect_bd_net -net AesSync_0_AesWrToRamO [get_bd_pins AesSync_0/AesWrToRamO] [get_bd_pins AesSync_1/AesWrToRamI]
  ...
  connect_bd_net -net AesSync_1_AesWrRamAddressO [get_bd_pins AesSync_1/AesWrRamAddressO] [get_bd_pins AesSync_2/AesWrRamAddressI]
  connect_bd_net -net AesSync_1_AesWrToRamO [get_bd_pins AesSync_1/AesWrToRamO] [get_bd_pins AesSync_2/AesWrToRamI]
  ...
  connect_bd_net -net AesSync_2_AesWrRamAddressO [get_bd_pins AesSync_2/AesWrRamAddressO] [get_bd_pins AesSync_3/AesWrRamAddressI]
  connect_bd_net -net AesSync_2_AesWrToRamO [get_bd_pins AesSync_2/AesWrToRamO] [get_bd_pins AesSync_3/AesWrToRamI]
  ...
  connect_bd_net -net AesSync_3_AesWrRamAddressO [get_bd_pins AesSync_3/AesWrRamAddressO] [get_bd_pins AesSync_4/AesWrRamAddressI]
  connect_bd_net -net AesSync_3_AesWrToRamO [get_bd_pins AesSync_3/AesWrToRamO] [get_bd_pins AesSync_4/AesWrToRamI]
  ...
  connect_bd_net -net AesSync_4_AesWrRamAddressO [get_bd_pins AesSync_4/AesWrRamAddressO] [get_bd_pins AesSync_5/AesWrRamAddressI]
  connect_bd_net -net AesSync_4_AesWrToRamO [get_bd_pins AesSync_4/AesWrToRamO] [get_bd_pins AesSync_5/AesWrToRamI]
  ...
  connect_bd_net -net AesSync_5_AesWrRamAddressO [get_bd_pins AesSync_5/AesWrRamAddressO] [get_bd_pins AesSync_6/AesWrRamAddressI]
  connect_bd_net -net AesSync_5_AesWrToRamO [get_bd_pins AesSync_5/AesWrToRamO] [get_bd_pins AesSync_6/AesWrToRamI]
  ...
  connect_bd_net -net AesSync_6_AesWrRamAddressO [get_bd_pins AesSync_6/AesWrRamAddressO] [get_bd_pins AesSync_7/AesWrRamAddressI]
  connect_bd_net -net AesSync_6_AesWrToRamO [get_bd_pins AesSync_6/AesWrToRamO] [get_bd_pins AesSync_7/AesWrToRamI]
  ...
  connect_bd_net -net AesSync_7_AesWrRamAddressO [get_bd_pins AesSync_7/AesWrRamAddressO] [get_bd_pins AesSync_8/AesWrRamAddressI]
  connect_bd_net -net AesSync_7_AesWrToRamO [get_bd_pins AesSync_7/AesWrToRamO] [get_bd_pins AesSync_8/AesWrToRamI]
  ...
  connect_bd_net -net AesSync_8_AesWrRamAddressO [get_bd_pins AesSync_8/AesWrRamAddressO] [get_bd_pins AesSync_9/AesWrRamAddressI]
  connect_bd_net -net AesSync_8_AesWrToRamO [get_bd_pins AesSync_8/AesWrToRamO] [get_bd_pins AesSync_9/AesWrToRamI]
  ...
  connect_bd_net -net AesSync_9_AesWrRamAddressO [get_bd_ports WrRamAddressO] [get_bd_pins AesSync_9/AesWrRamAddressO]
  connect_bd_net -net AesSync_9_AesWrToRamO [get_bd_ports WrToRamO] [get_bd_pins AesSync_9/AesWrToRamO]
  ...
  connect_bd_net -net WrRamAddressI_1 [get_bd_ports WrRamAddressI] [get_bd_pins AesSync_0/AesWrRamAddressI]
  connect_bd_net -net WrToRamI_1 [get_bd_ports WrToRamI] [get_bd_pins AesSync_0/AesWrToRamI]
